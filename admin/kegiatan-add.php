...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
    <div>
        ...
        <h2 class="text-2xl md:text-3xl font-bold text-darkblue_alt">Tambah Kegiatan</h2>
        <p class="text-gray-400 text-sm mt-1">Publikasikan agenda atau kegiatan terbaru PKK</p>
    </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="judul" required value="<?= e($_POST['judul'] ?? '') ?>" placeholder="Masukkan judul kegiatan..."
                ...
                <div>
                    ...
                    <textarea name="konten" id="editor" rows="15" 
                              class="w-full bg-softgray border border-gray-200 text-darkblue_alt rounded-2xl px-5 py-4 text-sm focus:outline-none focus:border-accent focus:ring-4 focus:ring-accent/10 transition-all resize-none"><?= e($_POST['konten'] ?? '') ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="lokasi" value="<?= e($_POST['lokasi'] ?? '') ?>" placeholder="Contoh: Aula Kecamatan"
                           class="w-full bg-softgray border border-gray-200 text-darkblue_alt rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent transition-all">
                </div>
                ...
                <div>
                    ...
                    <div class="group relative bg-softgray border-2 border-dashed border-gray-200 rounded-2xl p-4 transition-all hover:border-accent">
                        ...
                        <div id="preview-placeholder" class="text-center py-4">
                            <i class="fas fa-cloud-upload-alt text-gray-300 text-3xl mb-2 group-hover:text-accent transition-colors"></i>
                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest group-hover:text-accent transition-colors">Klik untuk upload</p>
                        </div>
                        <img id="image-preview" class="hidden w-full h-40 object-cover rounded-xl shadow-sm">
                    </div>
                    <p class="text-[10px] text-gray-400 mt-2 font-medium"><i class="fas fa-info-circle mr-1"></i>Maksimal 5MB, format JPG/PNG/WEBP.</p>
                </div>
            </div>
        </div>
